  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        <div className="h-56 w-full">
            <a href="#">
                <img className="mx-auto h-full object-cover" src={product.thumbnail} alt="thumbnail" />
            </a>
        </div>
        <div className="pt-6">
            ...
            <div className="mt-4 flex items-center justify-between gap-4">
                <p className="text-2xl font-extrabold leading-tight text-gray-900">Rp {new Intl.NumberFormat("id-ID").format(product.price)}</p>
